...
```mermaid
graph TD
    User([User]) -->|Interacts via| Frontend
    ...
    subgraph "health-connect-api (Express.js)"
        ...
        BookingService[Booking & Coordination Service]
    end
...
- **Dynamic Routing**: Implements user flows like booking coordination (`app/patient/book/page.tsx`).
...
- **Schedule Optimizer**: A specialized dashboard that helps configure and verify schedules dynamically.
...
- **Stateless REST Architecture**: Enabling horizontal scalability for booking coordination and data retrieval.
...
gantt
    ...
    Booking Page          :done,    des2, 2026-03-03, 2026-03-05
